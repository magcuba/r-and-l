    ...
    <section className="py-16 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-foreground mb-4">Watch Our Latest Videos</h2>
          <p className="text-muted-foreground text-lg">
            Follow us on social media for car care tips and product demonstrations
          </p>
        </div>
        ...
        <div className="text-center mt-10">
          <p className="text-muted-foreground mb-4">Follow us for more content</p>
