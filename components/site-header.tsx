      ...
      <div className="border-b bg-muted/30">
        <div className="container max-w-7xl mx-auto flex h-10 items-center justify-between text-sm px-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="sm" onClick={toggleTheme} className="h-9 w-9 p-0 relative flex items-center justify-center">
          ...
          <nav className="container max-w-7xl mx-auto px-4 py-4 flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between py-3">
              <div className="flex items-center gap-2">
                ...
                <Button variant="outline" size="sm" onClick={toggleTheme} className="h-10 w-10 p-0 relative flex items-center justify-center">
                  <Sun className="h-5 w-5 rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0 absolute" />
                  <Moon className="h-5 w-5 rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100 absolute" />
                  <span className="sr-only">Toggle theme</span>
                </Button>
